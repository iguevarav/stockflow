...
@section('title', 'Nuevo Cliente - Sistema de Inventario')
    ...
    <div class="table-container mt-4">
        <div class="table-header d-flex justify-content-between align-items-center flex-wrap">
            <span class="text-warning" style="font-weight:600; font-size:14px;">
                <i class="fas fa-exclamation-circle me-1"></i> Todos los campos son obligatorios
            </span>
            ...
            <div class="d-flex flex-wrap gap-2 mt-2 mt-md-0">
                ...
                <button class="btn btn-new-record" type="submit" form="formRegistrarCliente">
