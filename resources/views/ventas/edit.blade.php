...
@section('page-title', 'Modificar Venta')
...
<div class="container-custom p-4 bg-white rounded shadow-sm">
    <form method="POST" action="{{ route('ventas.update', $venta->id) }}">
        ...
        <div id="carrito-productos">
            @include('ventas.partials.carrito', ['detalles' => $venta->detalles])
        </div>

        <div class="mt-4">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Actualizar Venta</button>
